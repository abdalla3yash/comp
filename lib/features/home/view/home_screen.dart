                  ...
                  state.videos == null
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return VideoCard(videoData: state.videos![index],);
                          },
                        ),
                 state.requestState == RequestState.loading && state.requestType == RequestType.pick ?  const LoaderVideoCard() : const AddVideoCard(),
